...
def vectorizer_wrapper(data, vectorizer='tfidf', stopwords=None):
    ...
    Args:
        ...
        vectorizer (str, optional): Select the vectorizer type. Implemented so far are: 'tfidf', 'count', 'hash', 'word2vec'. Defaults to 'tfidf'.
    ...
    if vectorizer == 'tfidf':
        ...
        print("Vectorizer {} is not implemented yet. Please select one of the following options: 'tfidf', 'count', 'hash', 'word2vec'.".format(vectorizer))
        exit()
